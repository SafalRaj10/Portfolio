...
import random
os.chdir("C:/Users/91785/PycharmProjects/pythonProject")
...
while True:
    ...
    with sr.Microphone() as source:                   #choosing default microphone as our source microphone
        ...
        elif ("open control panel" in data or "control panel open" in data):
            os.startfile("C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Immersive Control Panel.lnk")
        elif ("open youtube" in data or "youtube open" in data):
